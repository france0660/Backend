...
exports.saleProduct = async function(req, res) {
    try {
        ...
        VALUES ('${uuidv4() }', '${req.body.buyer_name}','${req.body.sale_name}','${req.body.sale_date}','${req.body.productname}','${req.body.quantity}','${req.body.priceperpiece}','${req.body.sale_status}');`;  
